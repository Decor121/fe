...
function Footer() {
  ...
  const [chatHistory, setChatHistory] = useState([
    { sender: 'bot', text: 'Xin chào! Bạn cần Hanoia hỗ trợ thông tin gì hôm nay?' }
  ]);
  ...
  const handleSendChat = (e) => {
    ...
    setTimeout(() => {
      setChatHistory((prev) => [
        ...
        {
          sender: 'bot',
          text: 'Cảm ơn bạn đã quan tâm đến Hanoia. Yêu cầu của bạn đã được chuyển tới chuyên viên tư vấn. Chúng tôi sẽ liên hệ lại ngay qua email/số điện thoại của bạn.'
        }
      ]);
    }, 1000);
  };
    ...
    <footer className="w-full bg-[#f6f5f2] text-neutral-800 border-t border-neutral-200/60 pt-16 pb-12 relative font-sans">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 xl:gap-12 pb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="space-y-3 text-[12px] text-neutral-500 leading-relaxed font-normal pr-4">
              <p className="font-medium text-neutral-700">Công ty TNHH Hanoia</p>
              <p>Địa chỉ trụ sở chính: Tầng 6, Số nhà 21, ngõ 2, Lê Văn Hưu, Phường Hai Bà Trưng, Thành phố Hà Nội, Việt Nam</p>
              <p>MST: 0108062837</p>
              <p>Thương hiệu Hanoia được phân phối chính thức bởi Công ty Cổ phần Quốc tế Tam Sơn</p>
        ...
        <div className="border-t border-neutral-300/40 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-neutral-400">
          <p>© {new Date().getFullYear()} HANOIA. Tất cả các quyền được bảo lưu.</p>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3.5">
        ...
        <button
          onClick={scrollToTop}
          className={`w-14 h-14 rounded-full bg-white text-neutral-800 flex items-center justify-center shadow-lg hover:bg-neutral-50 transition-all duration-300 cursor-pointer border border-neutral-200 hover:scale-105 active:scale-95 ${
            showScrollTop ? 'opacity-100 translate-y-0 visible' : 'opacity-0 translate-y-6 invisible'
          }`}

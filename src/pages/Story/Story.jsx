  ...
  const chapters = [
    {
      ...
      subtitle: 'The Roots',
      desc: 'Câu chuyện Hanoia bắt đầu từ lòng nhiệt huyết bảo tồn di sản thủ công Việt Nam. Chúng tôi bắt đầu hành trình tại các làng nghề sơn mài cổ truyền phía Bắc, nơi những bí quyết pha trộn nhựa cây sơn, tán lá vàng lá bạc đã được lưu truyền qua hàng thế kỷ.',
    ...
    },
    {
      ...
      desc: 'Mỗi tác phẩm Hanoia trải qua ít nhất 15 lớp sơn mài tỉ mỉ, xen kẽ giữa các công đoạn sơn, ủ ẩm và mài dưới nước. Sự hoàn hảo không nằm ở máy móc, mà ở sự nhạy cảm của đôi bàn tay nghệ nhân khi cảm nhận độ mịn, độ sâu của từng mảng màu cẩn vỏ trứng, xà cừ.',
    ...
    },
    {
      ...
      subtitle: 'The Fusion',
      desc: 'Hanoia tự hào hợp tác cùng các nhà thiết kế thời trang và nội thất danh tiếng từ Pháp và Châu Âu. Sự kết hợp giữa tinh thần đương đại phương Tây và bàn tay khéo léo của nghệ nhân Việt tạo ra những bộ sưu tập trang trí độc đáo, mang vẻ đẹp vượt thời gian.',
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-28 space-y-5">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-light text-neutral-900 leading-tight">
            Câu Chuyện <span className="font-semibold italic text-[#b08263]">Hanoia</span>
          </h1>
          ...
          {chapters.map((chap, index) => {
            ...
            return (
              ...
              >
                {/* Image Block */}
                <div
                  className={`lg:col-span-6 relative group overflow-hidden rounded-2xl border border-neutral-200 p-2 bg-neutral-50/50 shadow-sm ${
